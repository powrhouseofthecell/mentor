...
router.get('/', auth_controller.protect, middlewares.role_check, events_controller.get_all_events);
router.post('/create', auth_controller.protect, middlewares.role_check, events_controller.create);
